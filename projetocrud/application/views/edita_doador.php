 ...
 <h3 class="page-header">Adicionar novo doador</h3>
  ...
  <?php
    ...
    echo form_open(base_url().'MainController/editaDoador/'.$registro[0]->cpf);
      ...
      echo form_input($attcontato,set_value('tel1',$registro[0]->tel1));
      ...
      echo form_input($attcontato2,set_value('tel2',$registro[0]->tel2));
      ...
      echo form_input($attdtnasc,set_value('dtnasc',$registro[0]->dtnasc));

      echo form_label('CPF','campo6');
      $attcpf = array('type'=>'text','class'=>'form-control cep-mask','id'=>'cpf','name'=>'cpf','placeholder'=>'Ex.: 000000000-00','readonly'=>'readonly');
      echo form_input($attcpf,set_value('cpf',$registro[0]->cpf));
      ...
      echo form_input($attvalor,set_value('doacao',$registro[0]->doacao));
